...
public class TTTMethods_CMW_Spring2017
{
...
//adjust user input to map to index
userRow = userRow - 1;
...
////test if a winner
public static boolean testIfWinner(String[][] board, String player, int count, String placeHolderString)
{  
if(count < 5)
	return false;
else		
{	
///test 1
if(!board[0][0].equals(placeHolderString) &&  board[0][0].equals(board[0][1]) &&
...
///test2
if(!board[1][0].equals(placeHolderString) &&  board[1][0].equals(board[1][1]) &&
...
///test3
if(!board[2][0].equals(placeHolderString) &&  board[2][0].equals(board[2][1]) &&
...
///test4
if(!board[0][0].equals(placeHolderString) &&  board[0][0].equals(board[1][0]) &&
...
///test5
if(!board[0][1].equals(placeHolderString) &&  board[0][1].equals(board[1][1]) &&
...
///test6
if(!board[0][2].equals(placeHolderString) &&  board[0][2].equals(board[1][2]) &&
...
///test7
if(!board[0][0].equals(placeHolderString) &&  board[0][0].equals(board[1][1]) &&
...
///test8
if(!board[0][2].equals(placeHolderString) &&  board[0][2].equals(board[1][1]) &&
...
return false;//keep compiler happy SHOULD NEVER BE REACHED
...
public static String[][] populateArray(String[][] boardToBePopulated, String symbolToUse)
        ...
        return boardToBePopulated;//dont need to return anything
